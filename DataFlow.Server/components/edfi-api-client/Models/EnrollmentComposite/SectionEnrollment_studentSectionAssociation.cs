...
{
    public class SectionEnrollment_studentSectionAssociation 
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// </summary>
        public List<SectionEnrollment_studentSectionAssociation_studentAddress> addresses { get; set; }

        /// <summary>
        /// An unordered collection of studentCharacteristics.  
        /// </summary>
        public List<SectionEnrollment_studentSectionAssociation_studentCharacteristic> characteristics { get; set; }

        /// <summary>
        /// An unordered collection of studentCohortYears.  
        /// </summary>
        public List<SectionEnrollment_studentSectionAssociation_studentCohortYear> cohortYears { get; set; }

        /// <summary>
        /// An unordered collection of studentElectronicMails.  
        /// </summary>
        public List<SectionEnrollment_studentSectionAssociation_studentElectronicMail> electronicMails { get; set; }

        /// <summary>
        /// An unordered collection of studentIdentificationCodes.  
        /// </summary>
        public List<SectionEnrollment_studentSectionAssociation_studentIdentificationCode> identificationCodes { get; set; }

        /// <summary>
        /// An unordered collection of studentIndicators.  
        /// </summary>
        public List<SectionEnrollment_studentSectionAssociation_studentIndicator> indicators { get; set; }

        /// <summary>
        /// An unordered collection of studentLanguages.  
        /// </summary>
        public List<SectionEnrollment_studentSectionAssociation_studentLanguage> languages { get; set; }

        /// <summary>
        /// An unordered collection of studentProgramParticipations.  
        /// </summary>
        public List<SectionEnrollment_studentSectionAssociation_studentProgramParticipation> programParticipations { get; set; }

        /// <summary>
        /// An unordered collection of studentRaces.  
        /// </summary>
        public List<SectionEnrollment_studentSectionAssociation_studentRace> races { get; set; }

        /// <summary>
        /// An unordered collection of studentTelephones.  
        /// </summary>
        public List<SectionEnrollment_studentSectionAssociation_studentTelephone> telephones { get; set; }

        /// <summary>
        /// An unordered collection of studentSchoolAssociations.  
        /// </summary>
        public List<SectionEnrollment_studentSectionAssociation_studentSchoolAssociation> schoolAssociations { get; set; }
