...
namespace EdFi.OdsApi.Models.School_and_Student 
{
    public class School_Readable 
    {
        ...
        /// </summary>
        public List<EducationOrganizationInstitutionTelephone_School_Readable> institutionTelephones { get; set; }
        ...
        /// </summary>
        public List<EducationOrganizationInternationalAddress_School_Readable> internationalAddresses { get; set; }

        /// <summary>
        /// An unordered collection of schoolCategories.  The category of school. (e.g., High School, Middle School or Elementary School).
        /// </summary>
        public List<SchoolCategory_Readable> schoolCategories { get; set; }
