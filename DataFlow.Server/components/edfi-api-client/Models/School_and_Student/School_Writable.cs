...
namespace EdFi.OdsApi.Models.School_and_Student 
{
    public class School_Writable 
    {
        ...
        /// </summary>
        public List<EducationOrganizationAddress_School_Writable> addresses { get; set; }
        ...
        /// </summary>
        public List<EducationOrganizationCategory_School_Writable> educationOrganizationCategories { get; set; }
        ...
        /// </summary>
        public List<EducationOrganizationIdentificationCode_School_Writable> identificationCodes { get; set; }
        ...
        /// </summary>
        public List<EducationOrganizationInstitutionTelephone_School_Writable> institutionTelephones { get; set; }
        ...
        /// </summary>
        public List<EducationOrganizationInternationalAddress_School_Writable> internationalAddresses { get; set; }

        /// <summary>
        /// An unordered collection of schoolCategories.  The category of school. (e.g., High School, Middle School or Elementary School).
        /// </summary>
        public List<SchoolCategory_Writable> schoolCategories { get; set; }

        /// <summary>
        /// An unordered collection of schoolGradeLevels.  The grade levels served at the school.
        /// </summary>
        public List<SchoolGradeLevel_Writable> gradeLevels { get; set; }
