...
namespace EdFi.OdsApi.Api.Descriptors 
{
    public class EntryTypeDescriptorsApi 
    {
        ...
        public IRestResponse<List<EntryTypeDescriptor>> GetEntryTypeDescriptorsAll(int? offset= null, int? limit= null) 
        {
            ...
            var response = client.Execute<List<EntryTypeDescriptor>>(request);
        ...
        /// <param name="entryType">Key for Entry</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<EntryTypeDescriptor>> GetEntryTypeDescriptorsAll(int? offset= null, int? limit= null, int? entryTypeDescriptorId= null, string entryType= null) 
        {
            var request = new RestRequest("/entryTypeDescriptors", Method.GET);
            request.RequestFormat = DataFormat.Json;
            ...
            if (entryType != null)
                request.AddParameter("entryType", entryType);
            var response = client.Execute<List<EntryTypeDescriptor>>(request);
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<EntryTypeDescriptor> GetEntryTypeDescriptorByKey(int? entryTypeDescriptorId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/entryTypeDescriptors", Method.GET);
            request.RequestFormat = DataFormat.Json;
            ...
            var response = client.Execute<EntryTypeDescriptor>(request);
        ...
        /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<EntryTypeDescriptor> GetEntryTypeDescriptorsById(string id, string IfNoneMatch= null) 
        {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse DeleteEntryTypeDescriptorById(string id, string IfMatch= null) 
        {
