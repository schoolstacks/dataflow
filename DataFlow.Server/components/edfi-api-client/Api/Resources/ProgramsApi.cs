...
namespace EdFi.OdsApi.Api.Resources 
{
    public class ProgramsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<Program>> GetProgramsAll(int? offset= null, int? limit= null, int? educationOrganizationId= null, string type= null, string name= null, string programId= null, string sponsorType= null, string id= null) 
        {
            var request = new RestRequest("/programs", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<Program> GetProgramByKey(int? educationOrganizationId, string type, string name, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/programs", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (educationOrganizationId == null || type == null || name == null ) 
