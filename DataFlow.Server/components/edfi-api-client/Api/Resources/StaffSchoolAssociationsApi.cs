...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StaffSchoolAssociationsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StaffSchoolAssociation>> GetStaffSchoolAssociationsAll(int? offset= null, int? limit= null, string staffUniqueId= null, string programAssignmentDescriptor= null, int? schoolId= null, int? schoolYear= null, string id= null) 
        {
            var request = new RestRequest("/staffSchoolAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StaffSchoolAssociation> GetStaffSchoolAssociationByKey(string staffUniqueId, string programAssignmentDescriptor, int? schoolId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/staffSchoolAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
