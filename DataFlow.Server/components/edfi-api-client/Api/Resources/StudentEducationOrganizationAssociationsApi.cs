...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StudentEducationOrganizationAssociationsApi 
    {
        ...
        public IRestResponse<List<StudentEducationOrganizationAssociation>> GetStudentEducationOrganizationAssociationsAll(int? offset= null, int? limit= null) 
        {
            ...
            var response = client.Execute<List<StudentEducationOrganizationAssociation>>(request);
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentEducationOrganizationAssociation>> GetStudentEducationOrganizationAssociationsAll(int? offset= null, int? limit= null, string studentUniqueId= null, int? educationOrganizationId= null, string responsibilityDescriptor= null, string id= null) 
        {
            var request = new RestRequest("/studentEducationOrganizationAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentEducationOrganizationAssociation> GetStudentEducationOrganizationAssociationByKey(string studentUniqueId, int? educationOrganizationId, string responsibilityDescriptor, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentEducationOrganizationAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (studentUniqueId == null || educationOrganizationId == null || responsibilityDescriptor == null ) 
            ...
            var response = client.Execute<StudentEducationOrganizationAssociation>(request);
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse PostStudentEducationOrganizationAssociations(StudentEducationOrganizationAssociation body) 
        {
        ...
        /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentEducationOrganizationAssociation> GetStudentEducationOrganizationAssociationsById(string id, string IfNoneMatch= null) 
        {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse PutStudentEducationOrganizationAssociation(string id, string IfMatch, StudentEducationOrganizationAssociation body) 
        {
