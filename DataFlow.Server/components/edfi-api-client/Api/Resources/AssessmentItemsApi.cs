...
namespace EdFi.OdsApi.Api.Resources 
{
    public class AssessmentItemsApi 
    {
        ...
        public AssessmentItemsApi(IRestClient client)
        {
            this.client = client;
        }
        ...
        public IRestResponse<List<AssessmentItem>> GetAssessmentItemsAll(int? offset= null, int? limit= null) 
        {
            var request = new RestRequest("/assessmentItems", Method.GET);
            ...
            var response = client.Execute<List<AssessmentItem>>(request);
        ...
        /// <param name="categoryType">Category or type of the assessment item.  For example:  Multiple choice  Analytic  Prose  ....</param>
        ...
        /// <param name="correctResponse">The correct response for the assessment item.</param>
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<AssessmentItem>> GetAssessmentItemsAll(int? offset= null, int? limit= null, string assessmentTitle= null, string academicSubjectDescriptor= null, string assessedGradeLevelDescriptor= null, int? version= null, string identificationCode= null, string categoryType= null, int? maxRawScore= null, string correctResponse= null, string expectedTimeAssessed= null, string nomenclature= null, string id= null) 
        {
            var request = new RestRequest("/assessmentItems", Method.GET);
            request.RequestFormat = DataFormat.Json;
            ...
            if (correctResponse != null)
                request.AddParameter("correctResponse", correctResponse);
            if (expectedTimeAssessed != null)
                request.AddParameter("expectedTimeAssessed", expectedTimeAssessed);
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<AssessmentItem> GetAssessmentItemByKey(string assessmentTitle, string academicSubjectDescriptor, string assessedGradeLevelDescriptor, int? version, string identificationCode, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/assessmentItems", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (assessmentTitle == null || academicSubjectDescriptor == null || assessedGradeLevelDescriptor == null || version == null || identificationCode == null ) 
            ...
            var response = client.Execute<AssessmentItem>(request);
        ...
        /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<AssessmentItem> GetAssessmentItemsById(string id, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/assessmentItems/{id}", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse DeleteAssessmentItemById(string id, string IfMatch= null) 
        {
            var request = new RestRequest("/assessmentItems/{id}", Method.DELETE);
            request.RequestFormat = DataFormat.Json;
