...
namespace EdFi.OdsApi.Api.Resources 
{
    public class ContractedStaffsApi 
    {
        ...
        public IRestResponse<List<ContractedStaff>> GetContractedStaffsAll(int? offset= null, int? limit= null) 
        {
            ...
            var response = client.Execute<List<ContractedStaff>>(request);
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<ContractedStaff>> GetContractedStaffsAll(int? offset= null, int? limit= null, string staffUniqueId= null, int? educationOrganizationId= null, string accountNumber= null, int? fiscalYear= null, DateTime? asOfDate= null, double? amountToDate= null, string id= null) 
        {
            var request = new RestRequest("/contractedStaffs", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<ContractedStaff> GetContractedStaffByKey(string staffUniqueId, int? educationOrganizationId, string accountNumber, int? fiscalYear, DateTime? asOfDate, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/contractedStaffs", Method.GET);
            request.RequestFormat = DataFormat.Json;
            ...
            var response = client.Execute<ContractedStaff>(request);
        ...
        /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<ContractedStaff> GetContractedStaffsById(string id, string IfNoneMatch= null) 
        {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse DeleteContractedStaffById(string id, string IfMatch= null) 
        {
