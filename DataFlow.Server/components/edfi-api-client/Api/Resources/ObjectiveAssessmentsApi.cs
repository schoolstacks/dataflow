...
namespace EdFi.OdsApi.Api.Resources 
{
    public class ObjectiveAssessmentsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<ObjectiveAssessment>> GetObjectiveAssessmentsAll(int? offset= null, int? limit= null, string assessmentTitle= null, string academicSubjectDescriptor= null, string assessedGradeLevelDescriptor= null, int? version= null, string identificationCode= null, string parentIdentificationCode= null, int? maxRawScore= null, double? percentOfAssessment= null, string nomenclature= null, string description= null, string id= null) 
        {
            var request = new RestRequest("/objectiveAssessments", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<ObjectiveAssessment> GetObjectiveAssessmentByKey(string assessmentTitle, string academicSubjectDescriptor, string assessedGradeLevelDescriptor, int? version, string identificationCode, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/objectiveAssessments", Method.GET);
            request.RequestFormat = DataFormat.Json;
