...
namespace DataFlow.EdFi.Models.Descriptors 
{
    public class LevelDescriptor 
    {
        ...
        /// <summary>
        /// An unordered collection of levelDescriptorGradeLevels.  The mapping to known grade levels for which certification exists.
        /// </summary>
        public List<LevelDescriptorGradeLevel> gradeLevels { get; set; }
