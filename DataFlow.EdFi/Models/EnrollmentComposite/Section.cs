...
namespace DataFlow.EdFi.Models.EnrollmentComposite 
{
    public class Section 
    {
        ...
        public Section_session sessionReference { get; set; }

        public Section_classPeriod classPeriodReference { get; set; }

        public Section_courseOffering courseOfferingReference { get; set; }

        public Section_location locationReference { get; set; }

        public Section_school schoolReference { get; set; }

        /// <summary>
        /// An unordered collection of staffSectionAssociations.  
        /// </summary>
        public List<Section_staffSectionAssociation> staff { get; set; }

        /// <summary>
        /// An unordered collection of studentSectionAssociations.  
        /// </summary>
        public List<Section_studentSectionAssociation> students { get; set; }
