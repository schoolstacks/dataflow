...
namespace DataFlow.EdFi.Api.Types 
{
    public class SchoolTypesApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<SchoolType>> GetSchoolTypesAll(int? offset= null, int? limit= null, int? schoolTypeId= null, string codeValue= null, string description= null, string shortDescription= null, string id= null) 
        {
            var request = new RestRequest("/schoolTypes", Method.GET);
            request.RequestFormat = DataFormat.Json;
