...
namespace DataFlow.EdFi.Api.Resources 
{
    public class GradesApi 
    {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<Grade> GetGradeByKey(string gradingPeriodDescriptor, DateTime? gradingPeriodBeginDate, string type, string studentUniqueId, int? schoolId, string classPeriodName, string classroomIdentificationCode, string localCourseCode, string uniqueSectionCode, int? sequenceOfCourse, int? schoolYear, string termDescriptor, DateTime? beginDate, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/grades", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (gradingPeriodDescriptor == null || gradingPeriodBeginDate == null || type == null || studentUniqueId == null || schoolId == null || classPeriodName == null || classroomIdentificationCode == null || localCourseCode == null || uniqueSectionCode == null || sequenceOfCourse == null || schoolYear == null || termDescriptor == null || beginDate == null ) 
