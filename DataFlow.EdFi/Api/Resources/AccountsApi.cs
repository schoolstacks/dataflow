...
namespace DataFlow.EdFi.Api.Resources 
{
    public class AccountsApi 
    {
        ...
        public AccountsApi(IRestClient client)
        {
            this.client = client;
        }
        ...
        public IRestResponse<List<Account>> GetAccountsAll(int? offset= null, int? limit= null) 
        {
        ...
        /// <param name="number">The alpha-numeric string that identifies the account.</param>
        /// <param name="fiscalYear">The financial accounting year.</param>
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<Account>> GetAccountsAll(int? offset= null, int? limit= null, int? educationOrganizationId= null, string number= null, int? fiscalYear= null, string id= null) 
        {
            var request = new RestRequest("/accounts", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<Account> GetAccountByKey(int? educationOrganizationId, string number, int? fiscalYear, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/accounts", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (educationOrganizationId == null || number == null || fiscalYear == null ) 
        ...
        /// </summary>
        /// <param name="body">The JSON representation of the &quot;account&quot; resource to be created or updated.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse PostAccounts(Account body) 
        {
        ...
        /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<Account> GetAccountsById(string id, string IfNoneMatch= null) 
        {
        ...
        /// <param name="body">The JSON representation of the &quot;account&quot; resource to be updated.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse PutAccount(string id, string IfMatch, Account body) 
        {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse DeleteAccountById(string id, string IfMatch= null) 
        {
