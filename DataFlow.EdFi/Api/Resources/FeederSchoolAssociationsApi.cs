...
namespace DataFlow.EdFi.Api.Resources 
{
    public class FeederSchoolAssociationsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<FeederSchoolAssociation>> GetFeederSchoolAssociationsAll(int? offset= null, int? limit= null, int? feederSchoolId= null, int? schoolId= null, DateTime? beginDate= null, DateTime? endDate= null, string feederRelationshipDescription= null, string id= null) 
        {
            var request = new RestRequest("/feederSchoolAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<FeederSchoolAssociation> GetFeederSchoolAssociationByKey(int? feederSchoolId, int? schoolId, DateTime? beginDate, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/feederSchoolAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (feederSchoolId == null || schoolId == null || beginDate == null ) 
