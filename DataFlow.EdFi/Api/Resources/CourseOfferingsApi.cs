...
namespace DataFlow.EdFi.Api.Resources 
{
    public class CourseOfferingsApi 
    {
        ...
        public CourseOfferingsApi(IRestClient client)
        {
            this.client = client;
        }
        ...
        public IRestResponse<List<CourseOffering>> GetCourseOfferingsAll(int? offset= null, int? limit= null) 
        {
            var request = new RestRequest("/courseOfferings", Method.GET);
            ...
            var response = client.Execute<List<CourseOffering>>(request);
        ...
        /// <param name="offset">Indicates how many items should be skipped before returning results.</param>
        /// <param name="limit">Indicates the maximum number of items that should be returned in the results (defaults to 25).</param>
        /// <param name="localCourseCode">The local code assigned by the LEA that identifies the organization of subject matter and related learning experiences provided for the instruction of students.</param>
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<CourseOffering>> GetCourseOfferingsAll(int? offset= null, int? limit= null, string localCourseCode= null, int? schoolId= null, int? schoolYear= null, string termDescriptor= null, string localCourseTitle= null, int? instructionalTimePlanned= null, string courseCode= null, int? educationOrganizationId= null, string id= null) 
        {
            var request = new RestRequest("/courseOfferings", Method.GET);
            request.RequestFormat = DataFormat.Json;
            ...
            if (localCourseTitle != null)
                request.AddParameter("localCourseTitle", localCourseTitle);
            if (instructionalTimePlanned != null)
                request.AddParameter("instructionalTimePlanned", instructionalTimePlanned);
            if (courseCode != null)
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<CourseOffering> GetCourseOfferingByKey(string localCourseCode, int? schoolId, int? schoolYear, string termDescriptor, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/courseOfferings", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (localCourseCode == null || schoolId == null || schoolYear == null || termDescriptor == null ) 
            ...
            var response = client.Execute<CourseOffering>(request);
        ...
        /// </summary>
        /// <param name="body">The JSON representation of the &quot;courseOffering&quot; resource to be created or updated.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse PostCourseOfferings(CourseOffering body) 
        {
            var request = new RestRequest("/courseOfferings", Method.POST);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<CourseOffering> GetCourseOfferingsById(string id, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/courseOfferings/{id}", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse DeleteCourseOfferingById(string id, string IfMatch= null) 
        {
            var request = new RestRequest("/courseOfferings/{id}", Method.DELETE);
            request.RequestFormat = DataFormat.Json;
