...
namespace DataFlow.EdFi.Api.Resources 
{
    public class BellSchedulesApi 
    {
        ...
        public IRestResponse<List<BellSchedule>> GetBellSchedulesAll(int? offset= null, int? limit= null) 
        {
            ...
            var response = client.Execute<List<BellSchedule>>(request);
        ...
        /// <param name="gradeLevelDescriptor">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.</param>
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<BellSchedule>> GetBellSchedulesAll(int? offset= null, int? limit= null, string name= null, string gradeLevelDescriptor= null, int? schoolId= null, DateTime? date= null, string id= null) 
        {
            var request = new RestRequest("/bellSchedules", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<BellSchedule> GetBellScheduleByKey(string name, string gradeLevelDescriptor, int? schoolId, DateTime? date, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/bellSchedules", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (name == null || gradeLevelDescriptor == null || schoolId == null || date == null ) 
            ...
            var response = client.Execute<BellSchedule>(request);
        ...
        /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<BellSchedule> GetBellSchedulesById(string id, string IfNoneMatch= null) 
        {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse DeleteBellScheduleById(string id, string IfMatch= null) 
        {
