...
namespace DataFlow.EdFi.Api.Resources 
{
    public class StudentDisciplineIncidentAssociationsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentDisciplineIncidentAssociation>> GetStudentDisciplineIncidentAssociationsAll(int? offset= null, int? limit= null, string studentUniqueId= null, int? schoolId= null, string incidentIdentifier= null, string studentParticipationCodeType= null, string id= null) 
        {
            var request = new RestRequest("/studentDisciplineIncidentAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentDisciplineIncidentAssociation> GetStudentDisciplineIncidentAssociationByKey(string studentUniqueId, int? schoolId, string incidentIdentifier, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentDisciplineIncidentAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (studentUniqueId == null || schoolId == null || incidentIdentifier == null ) 
