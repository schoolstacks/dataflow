...
namespace DataFlow.EdFi.Api.Resources 
{
    public class StudentSpecialEducationProgramAssociationsApi 
    {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentSpecialEducationProgramAssociation>> GetStudentSpecialEducationProgramAssociationsAll(int? offset= null, int? limit= null, string studentUniqueId= null, int? educationOrganizationId= null, string programType= null, string programName= null, int? programEducationOrganizationId= null, DateTime? beginDate= null, bool? ideaEligibility= null, string specialEducationSettingDescriptor= null, double? specialEducationHoursPerWeek= null, double? schoolHoursPerWeek= null, bool? multiplyDisabled= null, bool? medicallyFragile= null, DateTime? lastEvaluationDate= null, DateTime? iepReviewDate= null, DateTime? iepBeginDate= null, DateTime? iepEndDate= null) 
        {
            var request = new RestRequest("/studentSpecialEducationProgramAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentSpecialEducationProgramAssociation> GetStudentSpecialEducationProgramAssociationByKey(string studentUniqueId, int? educationOrganizationId, string programType, string programName, int? programEducationOrganizationId, DateTime? beginDate, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentSpecialEducationProgramAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
