...
namespace DataFlow.EdFi.Api.Resources 
{
    public class ReportCardsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<ReportCard>> GetReportCardsAll(int? offset= null, int? limit= null, string studentUniqueId= null, int? educationOrganizationId= null, string gradingPeriodDescriptor= null, DateTime? gradingPeriodBeginDate= null, int? schoolId= null, double? gpaGivenGradingPeriod= null, double? gpaCumulative= null, double? numberOfDaysAbsent= null, double? numberOfDaysInAttendance= null, int? numberOfDaysTardy= null, string id= null) 
        {
            var request = new RestRequest("/reportCards", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<ReportCard> GetReportCardByKey(string studentUniqueId, int? educationOrganizationId, string gradingPeriodDescriptor, DateTime? gradingPeriodBeginDate, int? schoolId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/reportCards", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (studentUniqueId == null || educationOrganizationId == null || gradingPeriodDescriptor == null || gradingPeriodBeginDate == null || schoolId == null ) 
