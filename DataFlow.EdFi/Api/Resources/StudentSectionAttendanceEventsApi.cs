...
namespace DataFlow.EdFi.Api.Resources 
{
    public class StudentSectionAttendanceEventsApi 
    {
        ...
        public StudentSectionAttendanceEventsApi(IRestClient client)
        {
            this.client = client;
        }
        ...
        public IRestResponse<List<StudentSectionAttendanceEvent>> GetStudentSectionAttendanceEventsAll(int? offset= null, int? limit= null) 
        {
            var request = new RestRequest("/studentSectionAttendanceEvents", Method.GET);
            ...
            var response = client.Execute<List<StudentSectionAttendanceEvent>>(request);
        ...
        /// <param name="attendanceEventCategoryDescriptor">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.</param>
        /// <param name="attendanceEventReason">The reason for the absence or tardy.</param>
        /// <param name="educationalEnvironmentType">The setting in which a child receives education and related services.  This is only used in the AttendanceEvent if different from that in the related Section.</param>
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentSectionAttendanceEvent>> GetStudentSectionAttendanceEventsAll(int? offset= null, int? limit= null, string studentUniqueId= null, string classroomIdentificationCode= null, int? schoolId= null, string classPeriodName= null, string localCourseCode= null, int? schoolYear= null, string termDescriptor= null, string uniqueSectionCode= null, int? sequenceOfCourse= null, DateTime? eventDate= null, string attendanceEventCategoryDescriptor= null, string attendanceEventReason= null, string educationalEnvironmentType= null, string id= null) 
        {
            var request = new RestRequest("/studentSectionAttendanceEvents", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentSectionAttendanceEvent> GetStudentSectionAttendanceEventByKey(string studentUniqueId, string classroomIdentificationCode, int? schoolId, string classPeriodName, string localCourseCode, int? schoolYear, string termDescriptor, string uniqueSectionCode, int? sequenceOfCourse, DateTime? eventDate, string attendanceEventCategoryDescriptor, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentSectionAttendanceEvents", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (studentUniqueId == null || classroomIdentificationCode == null || schoolId == null || classPeriodName == null || localCourseCode == null || schoolYear == null || termDescriptor == null || uniqueSectionCode == null || sequenceOfCourse == null || eventDate == null || attendanceEventCategoryDescriptor == null ) 
            ...
            var response = client.Execute<StudentSectionAttendanceEvent>(request);
        ...
        /// </summary>
        /// <param name="body">The JSON representation of the &quot;studentSectionAttendanceEvent&quot; resource to be created or updated.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse PostStudentSectionAttendanceEvents(StudentSectionAttendanceEvent body) 
        {
            var request = new RestRequest("/studentSectionAttendanceEvents", Method.POST);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentSectionAttendanceEvent> GetStudentSectionAttendanceEventsById(string id, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentSectionAttendanceEvents/{id}", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <param name="body">The JSON representation of the &quot;studentSectionAttendanceEvent&quot; resource to be updated.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse PutStudentSectionAttendanceEvent(string id, string IfMatch, StudentSectionAttendanceEvent body) 
        {
            var request = new RestRequest("/studentSectionAttendanceEvents/{id}", Method.PUT);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse DeleteStudentSectionAttendanceEventById(string id, string IfMatch= null) 
        {
            var request = new RestRequest("/studentSectionAttendanceEvents/{id}", Method.DELETE);
            request.RequestFormat = DataFormat.Json;
