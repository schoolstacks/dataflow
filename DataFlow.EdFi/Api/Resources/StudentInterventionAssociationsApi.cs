...
namespace DataFlow.EdFi.Api.Resources 
{
    public class StudentInterventionAssociationsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentInterventionAssociation>> GetStudentInterventionAssociationsAll(int? offset= null, int? limit= null, string studentUniqueId= null, string interventionIdentificationCode= null, int? educationOrganizationId= null, int? cohortEducationOrganizationId= null, string cohortIdentifier= null, string diagnosticStatement= null, string id= null) 
        {
            var request = new RestRequest("/studentInterventionAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentInterventionAssociation> GetStudentInterventionAssociationByKey(string studentUniqueId, string interventionIdentificationCode, int? educationOrganizationId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentInterventionAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (studentUniqueId == null || interventionIdentificationCode == null || educationOrganizationId == null ) 
