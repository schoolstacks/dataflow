...
namespace DataFlow.EdFi.Api.Resources 
{
    public class AssessmentsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<Assessment>> GetAssessmentsAll(int? offset= null, int? limit= null, string title= null, string assessedGradeLevelDescriptor= null, string academicSubjectDescriptor= null, int? version= null, string categoryDescriptor= null, string lowestAssessedGradeLevelDescriptor= null, string form= null, DateTime? revisionDate= null, int? maxRawScore= null, string nomenclature= null, string periodDescriptor= null, string familyTitle= null, string @namespace= null, string id= null) 
        {
            var request = new RestRequest("/assessments", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<Assessment> GetAssessmentByKey(string title, string assessedGradeLevelDescriptor, string academicSubjectDescriptor, int? version, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/assessments", Method.GET);
            request.RequestFormat = DataFormat.Json;

            // verify required params are set
            if (title == null || assessedGradeLevelDescriptor == null || academicSubjectDescriptor == null || version == null ) 
