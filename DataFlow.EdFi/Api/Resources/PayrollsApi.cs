...
namespace DataFlow.EdFi.Api.Resources 
{
    public class PayrollsApi 
    {
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<Payroll>> GetPayrollsAll(int? offset= null, int? limit= null, string staffUniqueId= null, int? educationOrganizationId= null, string accountNumber= null, int? fiscalYear= null, DateTime? asOfDate= null, double? amountToDate= null, string id= null) 
        {
            var request = new RestRequest("/payrolls", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<Payroll> GetPayrollByKey(string staffUniqueId, int? educationOrganizationId, string accountNumber, int? fiscalYear, DateTime? asOfDate, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/payrolls", Method.GET);
            request.RequestFormat = DataFormat.Json;
