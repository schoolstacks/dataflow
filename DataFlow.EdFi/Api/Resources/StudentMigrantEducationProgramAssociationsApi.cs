...
namespace DataFlow.EdFi.Api.Resources 
{
    public class StudentMigrantEducationProgramAssociationsApi 
    {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentMigrantEducationProgramAssociation>> GetStudentMigrantEducationProgramAssociationsAll(int? offset= null, int? limit= null, string studentUniqueId= null, int? educationOrganizationId= null, string programType= null, string programName= null, int? programEducationOrganizationId= null, DateTime? beginDate= null, bool? priorityForServices= null, DateTime? lastQualifyingMove= null, string continuationOfServicesReasonDescriptor= null, DateTime? usInitialEntry= null, DateTime? usMostRecentEntry= null, DateTime? usInitialSchoolEntry= null) 
        {
            var request = new RestRequest("/studentMigrantEducationProgramAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentMigrantEducationProgramAssociation> GetStudentMigrantEducationProgramAssociationByKey(string studentUniqueId, int? educationOrganizationId, string programType, string programName, int? programEducationOrganizationId, DateTime? beginDate, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentMigrantEducationProgramAssociations", Method.GET);
            request.RequestFormat = DataFormat.Json;
