...
namespace DataFlow.EdFi.Api.Descriptors 
{
    public class AdministrativeFundingControlDescriptorsApi 
    {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<AdministrativeFundingControlDescriptor>> GetAdministrativeFundingControlDescriptorsAll(int? offset= null, int? limit= null, int? administrativeFundingControlDescriptorId= null, string administrativeFundingControlType= null) 
        {
            var request = new RestRequest("/administrativeFundingControlDescriptors", Method.GET);
            request.RequestFormat = DataFormat.Json;
