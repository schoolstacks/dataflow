...
namespace DataFlow.EdFi.Api.Descriptors 
{
    public class ContinuationOfServicesReasonDescriptorsApi 
    {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<ContinuationOfServicesReasonDescriptor>> GetContinuationOfServicesReasonDescriptorsAll(int? offset= null, int? limit= null, int? continuationOfServicesReasonDescriptorId= null, string continuationOfServicesReasonType= null) 
        {
            var request = new RestRequest("/continuationOfServicesReasonDescriptors", Method.GET);
            request.RequestFormat = DataFormat.Json;
