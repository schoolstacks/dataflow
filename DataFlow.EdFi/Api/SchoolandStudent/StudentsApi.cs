...
namespace DataFlow.EdFi.Api.SchoolandStudent 
{
    public class StudentsApi 
    {
        ...
        public IRestResponse<List<Student_Readable>> GetStudentsAll(int? offset= null, int? limit= null) 
        {
            ...
            request.AddHeader("Accept", "application/vnd.ed-fi.student.school-and-student.readable+json");
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<Student_Readable> GetStudentByKey(string studentUniqueId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/students", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse PostStudents(Student_Writable body) 
        {
            ...
            request.Parameters.First(param => param.Type == ParameterType.RequestBody).Name = "application/vnd.ed-fi.student.school-and-student.writable+json";
        ...
        /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<Student_Readable> GetStudentsById(string id, string IfNoneMatch= null) 
        {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse PutStudent(string id, string IfMatch, Student_Writable body) 
        {
