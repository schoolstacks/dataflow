...
using System.Linq;
using DataFlow.EdFi.Models.School_and_Student;
using RestSharp;

namespace DataFlow.EdFi.Api.SchoolandStudent 
{
    public class SchoolsApi 
    {
        ...
        public IRestResponse<List<School_Readable>> GetSchoolsAll(int? offset= null, int? limit= null) 
        {
            ...
            request.AddHeader("Accept", "application/vnd.ed-fi.school.school-and-student.readable+json");
            var response = client.Execute<List<School_Readable>>(request);
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<School_Readable> GetSchoolByKey(int? schoolId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/schools", Method.GET);
            request.RequestFormat = DataFormat.Json;
            ...
            request.AddHeader("Accept", "application/vnd.ed-fi.school.school-and-student.readable+json");
            var response = client.Execute<School_Readable>(request);
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse PostSchools(School_Writable body) 
        {
            ...
            request.Parameters.First(param => param.Type == ParameterType.RequestBody).Name = "application/vnd.ed-fi.school.school-and-student.writable+json";
        ...
        /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<School_Readable> GetSchoolsById(string id, string IfNoneMatch= null) 
        {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse PutSchool(string id, string IfMatch, School_Writable body) 
        {
