...
namespace EdFi.OdsApi.Api.Resources 
{
    public class StudentInterventionAttendanceEventsApi 
    {
        ...
        public IRestResponse<List<StudentInterventionAttendanceEvent>> GetStudentInterventionAttendanceEventsAll(int? offset= null, int? limit= null) 
        {
            ...
            var response = client.Execute<List<StudentInterventionAttendanceEvent>>(request);
        ...
        /// <param name="id"></param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentInterventionAttendanceEvent>> GetStudentInterventionAttendanceEventsAll(int? offset= null, int? limit= null, string studentUniqueId= null, string interventionIdentificationCode= null, int? educationOrganizationId= null, DateTime? eventDate= null, string attendanceEventCategoryDescriptor= null, string attendanceEventReason= null, string educationalEnvironmentType= null, string id= null) 
        {
            var request = new RestRequest("/studentInterventionAttendanceEvents", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentInterventionAttendanceEvent> GetStudentInterventionAttendanceEventByKey(string studentUniqueId, string interventionIdentificationCode, int? educationOrganizationId, DateTime? eventDate, string attendanceEventCategoryDescriptor, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentInterventionAttendanceEvents", Method.GET);
            request.RequestFormat = DataFormat.Json;
            ...
            var response = client.Execute<StudentInterventionAttendanceEvent>(request);
        ...
        /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentInterventionAttendanceEvent> GetStudentInterventionAttendanceEventsById(string id, string IfNoneMatch= null) 
        {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse DeleteStudentInterventionAttendanceEventById(string id, string IfMatch= null) 
        {
