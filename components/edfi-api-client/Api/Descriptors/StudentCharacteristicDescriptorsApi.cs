...
namespace EdFi.OdsApi.Api.Descriptors 
{
    public class StudentCharacteristicDescriptorsApi 
    {
        ...
        public IRestResponse<List<StudentCharacteristicDescriptor>> GetStudentCharacteristicDescriptorsAll(int? offset= null, int? limit= null) 
        {
            ...
            var response = client.Execute<List<StudentCharacteristicDescriptor>>(request);
        ...
        /// <param name="offset">Indicates how many items should be skipped before returning results.</param>
        /// <param name="limit">Indicates the maximum number of items that should be returned in the results (defaults to 25).</param>
        /// <param name="studentCharacteristicDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.</param>
        /// <param name="studentCharacteristicType">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<List<StudentCharacteristicDescriptor>> GetStudentCharacteristicDescriptorsAll(int? offset= null, int? limit= null, int? studentCharacteristicDescriptorId= null, string studentCharacteristicType= null) 
        {
            var request = new RestRequest("/studentCharacteristicDescriptors", Method.GET);
            request.RequestFormat = DataFormat.Json;
            ...
            if (studentCharacteristicType != null)
                request.AddParameter("studentCharacteristicType", studentCharacteristicType);
            var response = client.Execute<List<StudentCharacteristicDescriptor>>(request);
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentCharacteristicDescriptor> GetStudentCharacteristicDescriptorByKey(int? studentCharacteristicDescriptorId, string IfNoneMatch= null) 
        {
            var request = new RestRequest("/studentCharacteristicDescriptors", Method.GET);
            request.RequestFormat = DataFormat.Json;
            ...
            var response = client.Execute<StudentCharacteristicDescriptor>(request);
        ...
        /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse<StudentCharacteristicDescriptor> GetStudentCharacteristicDescriptorsById(string id, string IfNoneMatch= null) 
        {
        ...
        /// <returns>A RestSharp <see cref="IRestResponse"/> instance containing the API response details.</returns>
        public IRestResponse DeleteStudentCharacteristicDescriptorById(string id, string IfMatch= null) 
        {
